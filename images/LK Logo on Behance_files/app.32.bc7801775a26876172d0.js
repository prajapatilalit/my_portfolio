(("undefined" != typeof global ? global : self).webpackJsonp = ("undefined" != typeof global ? global : self).webpackJsonp || []).push([ [ 32 ], {
    ...
    NnMW: function(t, e, n) {
        ...
        var k, P, j = n("WddM"), T = "FETCH_NOTIFICATION_COUNT", $ = "FETCH_MESSAGE_COUNT", L = "RESET_NOTIFICATION_COUNT", C = "FETCH_RESULTS", O = "UPDATE_NOTIFICATION_COUNT", M = "UPDATE_MESSAGE_COUNT", A = "UPDATE_TYPEAHEAD_RESULTS", I = "UPDATE_LAST_SEARCH_TERM", E = {
            namespaced: !0,
            state: function() {
                return {
                    messageCount: 0,
                ...
                return Object(i.__awaiter)(this, void 0, void 0, (function() {
                    ...
                    return Object(i.__generator)(this, (function(i) {
                        switch (i.label) {
                          ...
                          case 1:
                            return t = i.sent(), n(A, t), n(I, r), [ 3, 4 ];
        ...
        n("7x/C"), n("JtPf"), n("87if"), n("kYxP"), n("S7Gn")), F = n.n(z), V = n("hbkF"), Y = n.n(V), G = n("EZKv"), Q = (n("2G9S"), 
        n("LW0h"), n("jwue"), n("+oxZ"), n("wDoL")), Z = n.n(Q), q = n("6bQ5"), X = n.n(q), J = (n("hBpG"), 
        n("xeH2")), tt = n.n(J), et = n("wgY5"), nt = n.n(et), it = n("28MP"), at = n.n(it), rt = n("AR1p"), ot = n.n(rt), st = n("XMxj"), lt = n.n(st), ct = n("jPoj"), dt = n.n(ct), pt = n("HRFi"), ut = n.n(pt), bt = n("hVGs"), vt = n.n(bt), mt = n("X5bS"), ft = n.n(mt), ht = n("ZUcx"), gt = n.n(ht), _t = n("vd2y"), yt = n.n(_t), wt = n("RZ/S"), xt = n.n(wt), Nt = n("AAO9"), kt = n.n(Nt), Pt = n("+p0y"), jt = n.n(Pt), Tt = n("BZQn"), $t = n.n(Tt), Lt = n("rYGf"), Ct = n.n(Lt), Ot = n("A7qk"), Mt = n.n(Ot), At = n("mjmi"), It = n.n(At), Et = n("JwJj"), St = n.n(Et), Ut = n("6lsj"), Bt = n.n(Ut), Rt = n("RqAh"), Ht = n.n(Rt), Dt = n("/GyL"), Wt = n.n(Dt), Kt = n("PFHM"), zt = n.n(Kt), Ft = n("NNTl"), Vt = n.n(Ft), Yt = n("1+oB"), Gt = n.n(Yt), Qt = {
            ...
            adobelivestarted: Vt.a.template
        }, Zt = {
        ...
        }, qt = n("6P4k"), Xt = n.n(qt), Jt = at.a.extend({
            template: function(t) {
                return tt()(Xt()(t, this.generatePartials(t)));
            },
            ...
            VIEW_CLASS: Jt
        }), ee = (n("M+/F"), n("5BYb"), n("+eOo")), ne = n.n(ee), ie = n("LVYI"), ae = n.n(ie), re = at.a.extend({
            template: ne()(ae.a, tt.a),
            templateData: function() {
                var t = this._super();
            ...
            VIEW_CLASS: re
        }), se = n("39B/"), le = n("dwFx"), ce = n("MPHR"), de = n.n(ce), pe = n("iQhF"), ue = n.n(pe), be = at.a.extend({
            template: ne()(de.a, tt.a),
            templateData: function() {
                return {
            ...
            rendered: function() {
                this.$loading = le.default.init(this.$view), this.listenTo(this._model, "entries", this.draw), 
            ...
            empty: function(t) {
                var e = !t;
                this.$empty = this.$empty || tt()(ue()()), e ? this.$empty.remove() : this.$view.append(this.$empty);
            }
        }), ve = "/v2/notifications?action_set=bell-note-v1", me = Z.a.extend({
            refresh: function() {
            ...
            makeEntries: function(t) {
                ...
                for (n = 0; n < o.length; ++n) if (o[n + 1] && o[n + 1].action_key === o[n].action_key) r++; else {
                    if (r >= 2) {
                        for (e = new oe, i = n - r; i <= n; ++i) e.add(new te(o[i]));
                        a.push(e);
                    } else for (i = n - r; i <= n; ++i) a.push(new te(o[i]));
                    r = 0;
                }
                return a;
            }
        }).mixin(F.a), fe = (n("vrRf"), n("z84I"), n("KOtZ"), n("Ee2X"), n("+KXO"), n("/2/H")), he = n.n(fe), ge = n("yzPa"), _e = n.n(ge), ye = n("BHX3"), we = n("BarQ"), xe = n("+mWf"), Ne = n.n(xe), ke = n("OZle"), Pe = n.n(ke), je = n("HtMS"), Te = n.n(je), $e = n("BRwD"), Le = n.n($e), Ce = n("fViJ"), Oe = n.n(Ce), Me = n("Fhgk"), Ae = n.n(Me), Ie = ye.default.translate("notifications_invitation_declined", "Invitation declined"), Ee = {
            project_owner: {
            ...
            declineAndFade: function() {
                var t = new he.a;
                return this.$rejectBtn.text(Ie), this.$view.delay(1e3).fadeOut(250, t.resolve), 
                t;
            },
        ...
        }).mixin(we.a), Be = "/v2/notifications/invitations/", Re = Z.a.extend({
            update: function() {
                this._view.update();
            },
            accept: function() {
                Object(_.default)({
                    url: Be + this._model.get("id"),
                    type: "put"
            ...
            rendered: function() {
                this.$errorContainer = this.$view.find(".js-error-container"), this.$loading = le.default.init(this.$view), 
            ...
            VIEW_CLASS: He
        }).mixin(F.a), We = n("auWA"), Ke = n("pTUv"), ze = n.n(Ke), Fe = n("hHjz"), Ve = n.n(Fe), Ye = n("tBkL"), Ge = n.n(Ye), Qe = {
            mustache: Ve.a,
            ...
            _bindInfiniteScroll: function() {
                ...
                this._controller.more(), ze()(.5, e, this.selector), this._controller.on("destroy", (function() {
                    ze.a.off(e);
                }));
            },
        ...
        }, Ze = We.default.extend(Qe), qe = n("Kwjp").default.extend(Qe).extend({
            ...
            _count: 0,
            init: function() {
                this._propositions = new De, this.listenTo(this._propositions, "sync", (function(t) {
            ...
            more: function() {
                return Y.a.all([ this._super(), this._propositions.more() ]);
            }
        }), Je = n("hRZA"), tn = n("nE2t"), en = n("tLj1"), nn = n("XobZ"), an = n("wcfZ"), rn = n("Rh0G"), on = a.default.extend({
            components: {
                BehanceLogo: o,
                    ...
                    return Object(i.__generator)(this, (function(i) {
                        switch (i.label) {
                          ...
                          case 1:
                            ...
                            t)), this.inboxDialog.setContext(this.$refs.inboxTrigger), this.bellDialog = new Xe(((e = {})[this.dropdownMenuIdKey] = "notification", 
                          ...
                          case 2:
                            return this.isMobile = an.default.isMobile(), this.$route.name !== h.b || this.userDismissedLoginPrompt || setTimeout((function() {
            ...
            methods: Object(i.__assign)(Object(i.__assign)({
                ...
                navigateToInboxUrl: function() {
                    tn.default.replaceLocation(B.URL_INBOX);
                },
                languageSelectChanged: function(t) {
                    var e = t.target.value;
                    nn.default.setCookie(Je.COOKIE.LANGUAGE_SETTING, e, {
                        expires: 365
                    }), en.default.custom("localization", "Language changed by user", {
                        locale: e
                    }), tn.default.reloadLocation();
                },
                ...
                dismissSigninPrompt: function() {
                    this.shouldRenderTooltip = !1, nn.default.markDialogDismissed("login_prompt");
                }
            }),
            computed: Object(i.__assign)(Object(i.__assign)(Object(i.__assign)(Object(i.__assign)(Object(i.__assign)({}, Object(g.mapState)([ "gates" ])), Object(g.mapState)("primaryNav", [ "messageCount", "notificationCount", "isMinimal", "hideCreateProjectButton", "hideActivateButton", "typeaheadResults", "lastSearchTerm" ])), Object(g.mapState)("user", {
                ...
                userDismissedLoginPrompt: function() {
                    return nn.default.wasDialogDismissed("login_prompt");
                },
        ...
        var ln = Object(r.default)(on, (function() {
...
//# sourceMappingURL=app.32.bc7801775a26876172d0.js.map